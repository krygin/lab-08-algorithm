...
TEST_F(TestLab, Groups) {
  ...
  std::vector<Student> students2group = {student5, student3, student4};
  std::vector<Student> students3group = {student6, student10, student7,
                                         student9, student8};
  Group group1 = {"iu8-34", students1group};
  Group group2 = {"iu9-54", students2group};
  Group group3 = {"ibm3-12", students3group};
  std::vector<Group> result = {group3, group1, group2};
  std::vector<Group> groups = Groups(students);
  EXPECT_EQ(result, groups);
  // все из одной группы
  students = {student3, student4, student5};
  students2group = {student5, student3, student4};
